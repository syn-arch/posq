            ...
            <div class="col-md-3">
                ...
                <form action="setting.php" method="POST">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <?php $target = isset($_POST['target']) ? $_POST['target'] : $get_setting->target; ?>
                            <div class="col-md-6">
                                <div class="radio" style="margin-bottom: 0px; margin-top: 0px">
                                    <label>
                                        <input type="radio" name="target" value="<?php echo FCPATH ?>/application/modules/" <?php echo $target == FCPATH . 'application/modules/' ? 'checked' : ''; ?>>
                                        <?php echo FCPATH ?>application/modules/
                                    </label>
                                </div>                            
                            </div>
                            <div class="col-md-6">

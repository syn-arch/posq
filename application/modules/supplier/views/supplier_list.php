            ...
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <div class="box-title">
                        ...
                        <?php endif ?>
		<?php echo anchor(site_url('supplier/excel'), '<i class="fas fa-sign-out-alt"></i> Excel', 'class="btn btn-success"'); ?>
		<?php echo anchor(site_url('supplier/pdf'), '<i class="fas fa-sign-out-alt"></i> Pdf', 'class="btn btn-danger"'); ?>
                 ...
                 if (up == '1' && del == '1') {
                        var t = $(".dt").dataTable({
                                ...
                                columns: [
                                    ...
                                    {"data": "nama_supplier"},{"data": "alamat"},{"data": "no_telepon"},{"data": "email"},
                                    {
                                        "data" : "action",
                                        "orderable": false,
                                        "className" : "text-center"

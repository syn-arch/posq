            ...
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <div class="box-title">
                        ...
                        <?php endif ?>
                        <?php if ($access['c']): ?>
                            <a href="<?php echo base_url('pelanggan/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                        <?php endif ?>
		<?php echo anchor(site_url('pelanggan/excel'), '<i class="fas fa-sign-out-alt"></i> Excel', 'class="btn btn-success"'); ?>
		<?php echo anchor(site_url('pelanggan/pdf'), '<i class="fas fa-sign-out-alt"></i> Pdf', 'class="btn btn-danger"'); ?>
                 ...
                 if (up == '1' && del == '1') {
                        var t = $(".dt").dataTable({
                                ...
                                columns: [
                                    ...
                                    {"data": "nama_pelanggan"},{"data": "alamat"},{"data": "no_telepon"},{"data": "email"},
                                    {
                                        "data" : "action",
                                        "orderable": false,
                                        "className" : "text-center"

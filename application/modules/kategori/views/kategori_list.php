            ...
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <div class="box-title">
                        ...
                        <?php endif ?>
                        <?php if ($access['c']): ?>
                            <a href="<?php echo base_url('kategori/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                        <?php endif ?>
		<?php echo anchor(site_url('kategori/excel'), '<i class="fas fa-sign-out-alt"></i> Excel', 'class="btn btn-success"'); ?>
		<?php echo anchor(site_url('kategori/pdf'), '<i class="fas fa-sign-out-alt"></i> Pdf', 'class="btn btn-danger"'); ?>
